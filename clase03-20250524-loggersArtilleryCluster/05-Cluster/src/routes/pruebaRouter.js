...
router.get('/op1',(req,res)=>{
    ...
    console.log(valor1, valor2, resultado, `Procesado por worker: ${cluster.worker.id} - pid: ${process.pid}`)
...
router.get('/op2',(req,res)=>{
    ...
    console.log(contador, resultado, `Procesado por worker: ${cluster.worker.id} - pid: ${process.pid}`)
    console.timeEnd("Demora operación:")
